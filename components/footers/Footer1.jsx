        ...
        <div className={` ${fullWidth ? "container-full" : "container"}  `}>
          <div className="footer-top-wrap">
            ...
            <ul className="tf-social-icon style-large">
              <li>
                <span className="social-item social-facebook">
                  <i className="icon icon-fb" />
                </span>
              </li>
              <li>
                <span className="social-item social-instagram">
                  <i className="icon icon-instagram" />
                </span>
              </li>
              <li>
                <span className="social-item social-linkedin">
                  <i className="icon icon-linkedin" />
                </span>
              </li>
              <li>
                <span className="social-item social-x">
                ...
                <div className="footer-contact">
                  <ul className="footer-info">
                    <li className="item">
                      ...
                      123 Demo Street, Lima, Peru 15001
                    </li>
                    <li className="item">
                      <span className="box-icon">
                        <svg
                    ...
                    <li className="item">
                      ...
                      hello@klinperu-demo.com
                    </li>
                  </ul>
                  <span className="tf-btn btn-line-dark fw-normal">
            ...
            <div className="footer-inner-wrap footer-col-block s2">
              ...
              <div className="tf-collapse-content">
                <div className="footer-newsletter">
                  <iframe
                    title="Klin Peru Location"
                    src="https://www.google.com/maps?q=123%20Yarran%20st%2C%20Punchbowl%2C%20NSW%202196%2C%20Australia&output=embed"
                    width="100%"
                    height="280"
